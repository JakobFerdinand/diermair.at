@description('Name of the existing static web app to adopt.')
...
resource customDomain 'Microsoft.Web/staticSites/customDomains@2023-12-01' = [for domain in customDomains: {
  parent: site
  name: domain
}]
